...
* Для маленькой модели четко видно, что при одинаковом размере батча и одинаковом номере эпохи большее качество у модели с меньшим число ddp процессов, но для большой модели уже не наблюдается такая закономерность.
